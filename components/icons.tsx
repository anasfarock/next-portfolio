...
export function ZayupIcon(props: Omit<React.ComponentProps<typeof Image>, "src" | "alt">) {
  return (
    <Image
      src="/zayup.svg"
      alt="Zayup"
...
export function TechAccessIcon(props: Omit<React.ComponentProps<typeof Image>, "src" | "alt">) {
  return (
    <Image
      src="/techaccess.svg"
      alt="Tech Access"
